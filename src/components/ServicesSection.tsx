...
const services = [
  {
    ...
    portfolioUrl: '/portfolio?category=construction',
  ...
  },
  {
    ...
    portfolioUrl: '/portfolio?category=real-estate',
    color: 'bg-brand-blue/5',
  ...
  },
  {
    ...
    portfolioUrl: '/portfolio?category=interior-design',
    color: 'bg-brand-blue/5',
    iconColor: 'text-brand-accent',
  },
  {
    ...
    portfolioUrl: '/portfolio?category=consulting',
    color: 'bg-brand-blue/5',
    iconColor: 'text-brand-blue',
  },
  {
    ...
    portfolioUrl: '/portfolio?category=visualization',
    color: 'bg-brand-blue/5',
    iconColor: 'text-brand-accent',
  },
];
